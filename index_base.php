...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-4">
                            <div class="weather-widget">
                                ...
                                <h5>Clima Hoy</h5>
                                <p id="climaActual">Soleado, 22°C</p>
    ...
    <script>
        ...
        function generarSugerencia() {
            const sugerencias = [{
                    titulo: "Look Casual Universitario",
                    descripcion: "Perfecto para un día normal en la universidad",
                    prendas: ["Camiseta básica", "Jeans", "Zapatillas cómodas"],
                    tips: "Lleva una chaqueta ligera por si cambia el clima"
                },
                {
                    titulo: "Outfit Profesional",
                    descripcion: "Ideal para presentaciones o reuniones importantes",
                    prendas: ["Camisa formal", "Pantalón de vestir", "Zapatos formales"],
                    tips: "Asegúrate de tener todo planchado la noche anterior"
                },
                {
                    titulo: "Look Versátil",
                    descripcion: "Funciona tanto para universidad como para salir después",
                    prendas: ["Blusa semiformal", "Jeans oscuros", "Blazer ligero"],
                    tips: "Puedes quitar el blazer para un look más casual"
                }
            ];
            ...
            const html = `
                <div class="suggestion-card">
                    ...
                    <div class="mb-2">
                        ...
                        <ul class="mb-2">
                            ${sugerenciaAleatoria.prendas.map(prenda => `<li>${prenda}</li>`).join('')}
                        </ul>
                    </div>
